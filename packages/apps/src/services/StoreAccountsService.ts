...
export interface IStoreAccountsService {
  createAccount: (suri: string, pairType: KeypairType, options: CreateOptions, password: string, success: string) => ActionStatus
}
